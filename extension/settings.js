...
const DEFAULTS = {
  ...
  armTimeoutMs: 7000,
  provider: 'qwen',
  // Сервер один и локальный (vox_server). Ключ servers.local оставлен как был:
  // он уже записан в chrome.storage у установленных расширений.
  servers: { local: { url: 'http://127.0.0.1', port: 8000 } },
